...
import { Search, Plus, Eye, Edit, Trash2, X, Check, Shield, Mail, Phone, User as UserIcon } from "lucide-react";
                  ...
                  <tr key={c.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td className="px-4 py-3 text-sm">
                      <span className="font-mono text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">
                        {c.plain_password ? (showPassword ? c.plain_password : "••••••••") : "-"}
                      </span>
                    </td>
                    <td className="px-4 py-3 text-sm">
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <button type="button" onClick={() => setShowPassword((v) => !v)} className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 cursor-pointer text-xs">
